...
import net.nerdypuzzle.geckolib.ui.modgui.AEntityDataGroupGUI;
...
public class PluginElementTypes {
    ...
    public static ModElementType<?> AENTITYDATAGROUP;
    ...
    public static void load() {
        ...
        AENTITYDATAGROUP = register(
                new ModElementType<>("aentitydatagroup", (Character) 'X', AEntityDataGroupGUI::new, AEntityDataGroup.class)
        );
